...
def run_one_config(name: str, params: dict, train_data, test_data, obs_dim: int):
    ...
    model.save_checkpoint(f"checkpoints/tune_{name}.pt")

    print(f"\n--- Evaluación en test set: '{name}' ---")
...
if __name__ == "__main__":
    ...
    for name, params in CONFIGS.items():
        all_results[name] = run_one_config(name, params, train_data, test_data, obs_dim)
